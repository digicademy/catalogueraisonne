...
class Tx_Catalogueraisonne_ViewHelpers_AlphabetViewHelper extends Tx_Fluid_Core_ViewHelper_AbstractViewHelper {
	 ...
	 * Used in conjunction with the Alphabet.html template/partial. 
	 * 
	 * @param string $string Current iteration
	 * @param integer $length Determines the amount of starting letters that are used as a basis for the string comparison
	 * @param string $splitChar Can be used if strings should not be compared by starting letters but until a certain splitting character. Overrides $length.
	 * 
	 * @return string
	 */
