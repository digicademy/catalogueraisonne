...
/**
 * Functions that persons have in relation to a specific source
 */
class Tx_Catalogueraisonne_Domain_Model_SourcesPersonsRelations extends Tx_Extbase_DomainObject_AbstractValueObject {

	/**
	 * Each person has a specific function in respect to the source
	 *
	 * @var integer
	 */
	protected $function;
	...
	/**
	 * Special information about the persons function within the source context
	 *
	 * @var string
	 */
	 ...
	 * Returns the source
	 *
	 * @return Tx_Catalogueraisonne_Domain_Model_Sources $source
	 */
