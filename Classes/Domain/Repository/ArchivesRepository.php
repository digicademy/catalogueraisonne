...
/**
 * Repository for Tx_Catalogueraisonne_Domain_Model_Archives
 */
class Tx_Catalogueraisonne_Domain_Repository_ArchivesRepository extends Tx_Catalogueraisonne_Domain_Repository_CommonRepository {
