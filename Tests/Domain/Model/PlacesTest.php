...
/**
 * Testcase for class Tx_Catalogueraisonne_Domain_Model_Places.
 *
 * @version $Id$
 ...
 */
class Tx_Catalogueraisonne_Domain_Model_PlacesTest extends Tx_Extbase_Tests_Unit_BaseTestCase {
	/**
	 * @var Tx_Catalogueraisonne_Domain_Model_Places
	 */
	protected $fixture;

	public function setUp() {
		$this->fixture = new Tx_Catalogueraisonne_Domain_Model_Places();
	}
	...
	public function setLocalityForStringSetsLocality() { 
		$this->fixture->setLocality('Conceived at T3CON10');

		$this->assertSame(
			'Conceived at T3CON10',
			$this->fixture->getLocality()
		);
	}
